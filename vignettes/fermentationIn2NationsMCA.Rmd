...
During the SPISE2018 workshop we also ask the participants to 
fill in the same quesionnaire. 
...
so these boootrap-ratios need to be combined to 
create *pseudo-boostrap8 ratio for the qualitative varaibles.
...
bootstrap is testing to *homogeneity* which would indicate
...
is performed by the function `data4PCCAR::BR4varMCA`, 
...
## Map for the levels of variables (i.e., columns)
...
### Levels of variables: Map with important variables and lines for Dimensions 2 & 3
...
### Levels of variables: Maps with important and supplementary variables
